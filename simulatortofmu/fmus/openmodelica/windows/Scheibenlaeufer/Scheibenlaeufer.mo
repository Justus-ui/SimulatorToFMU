...
///////////// THE CODE BELOW HAS BEEN AUTOGENERATED //////////////
  ...
  Modelica.Blocks.Interfaces.RealInput x(start=0.0, unit="V")
    "Eingangsspannung" annotation(Placement(transformation(extent={{-122,68},{-100,90}})));
  Modelica.Blocks.Interfaces.RealOutput y (unit="V")
    "Generatorspannung" annotation(Placement(transformation(extent={{100,70},{120,90}})));
  // Configuration specific parameters coming from
  // the inputs of the Python export tool (SimulatorToFMU.py)
  parameter String patResScri = Modelica.Utilities.Files.loadResource("C:\\Users\\Justu\\Documents\\Projekt_MDT\\SimulatorToFMU\\Scheibenlaeufer_wrapper.py")
...
///////////// THE CODE ABOVE HAS BEEN AUTOGENERATED //////////////
  protected
    parameter String moduleName="Scheibenlaeufer_wrapper"
